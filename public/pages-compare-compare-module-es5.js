...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-compare-compare-module"], {
  ...
  function srcAppPagesCompareCompareComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var CompareComponent = /*#__PURE__*/function () {
      ...
      _createClass(CompareComponent, [{
        ...
        key: "enableSwiper",
        value: function enableSwiper() {
          var _this2 = this;

          setTimeout(function () {
            if (_this2.directiveRef) {
              _this2.config.keyboard = true;
              _this2.config.navigation = {
                nextEl: '.carousel-next',
                prevEl: '.carousel-prev'
              };
              _this2.config.simulateTouch = true;

              _this2.directiveRef.update();
            }
          });
        }
      }, {
        ...
        value: function watchForChanges() {
          ...
          this.watcher = this.mediaObserver.media$.subscribe(function (change) {
            if (change.mqAlias == 'xs' && _this3.appService.Data.compareList.length > 1) {
              _this3.enableSwiper();
            } else if (change.mqAlias == 'sm' && _this3.appService.Data.compareList.length > 2) {
              _this3.enableSwiper();
            } else if (change.mqAlias == 'md' && _this3.appService.Data.compareList.length > 3) {
              _this3.enableSwiper();
            } else if (change.mqAlias == 'lg' && _this3.appService.Data.compareList.length > 4) {
              _this3.enableSwiper();
            } else if (change.mqAlias == 'xl' && _this3.appService.Data.compareList.length > 4) {
              _this3.enableSwiper();
            } else {
              _this3.disableSwiper();
            }
          });
        }
      }]);
    ...
    CompareComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
  ...
  function srcAppPagesCompareCompareModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _compare_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./compare.component */
    "./src/app/pages/compare/compare.component.ts");

    var routes = [{
      path: '',
      component: _compare_component__WEBPACK_IMPORTED_MODULE_5__["CompareComponent"],
      pathMatch: 'full'
    }];
    ...
    CompareModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      declarations: [_compare_component__WEBPACK_IMPORTED_MODULE_5__["CompareComponent"]],
