...
/* harmony import */ var src_app_app_settings__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! src/app/app.settings */ "./src/app/app.settings.ts");
/* harmony import */ var src_app_app_models__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! src/app/app.models */ "./src/app/app.models.ts");
/* harmony import */ var src_app_theme_utils_app_validators__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! src/app/theme/utils/app-validators */ "./src/app/theme/utils/app-validators.ts");
...
let AgentComponent = class AgentComponent {
    constructor(appSettings, appService, activatedRoute, mediaObserver, fb) {
        ...
        this.viewCol = 33.3;
        this.count = 12;
        this.pagination = new src_app_app_models__WEBPACK_IMPORTED_MODULE_9__["Pagination"](1, this.count, null, 2, 0, 0);
    ...
    ngOnInit() {
        ...
        this.contactForm = this.fb.group({
            ...
            email: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_5__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_5__["Validators"].required, src_app_theme_utils_app_validators__WEBPACK_IMPORTED_MODULE_10__["emailValidator"]])],
    ...
    resetPagination() {
        ...
        this.pagination = new src_app_app_models__WEBPACK_IMPORTED_MODULE_9__["Pagination"](1, this.count, null, null, this.pagination.total, this.pagination.totalPages);
    }
    filterData(data) {
    ...
    searchChanged(event) {
        ...
        event.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["debounceTime"])(500), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["distinctUntilChanged"])()).subscribe(() => {
            if (!this.settings.searchOnBtnClick) {
                this.getProperties();
            }
        });
...
AgentComponent.propDecorators = {
    ...
    paginator: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"], args: [_angular_material_paginator__WEBPACK_IMPORTED_MODULE_3__["MatPaginator"],] }]
};
AgentComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-agent',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./agent.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/agents/agent/agent.component.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./agent.component.scss */ "./src/app/pages/agents/agent/agent.component.scss")).default]
    })
], AgentComponent);
...
AgentsComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-agents',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./agents.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/agents/agents.component.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./agents.component.scss */ "./src/app/pages/agents/agents.component.scss")).default]
    })
], AgentsComponent);
...
/* harmony import */ var _agents_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./agents.component */ "./src/app/pages/agents/agents.component.ts");
/* harmony import */ var _agent_agent_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./agent/agent.component */ "./src/app/pages/agents/agent/agent.component.ts");
...
const routes = [
    { path: '', component: _agents_component__WEBPACK_IMPORTED_MODULE_5__["AgentsComponent"], pathMatch: 'full' },
    { path: ':id', component: _agent_agent_component__WEBPACK_IMPORTED_MODULE_6__["AgentComponent"] }
];
let AgentsModule = class AgentsModule {
};
AgentsModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [
            _agents_component__WEBPACK_IMPORTED_MODULE_5__["AgentsComponent"],
