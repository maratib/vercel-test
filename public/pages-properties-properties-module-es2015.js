...
/* harmony import */ var _app_models__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../app.models */ "./src/app/app.models.ts");
...
let PropertiesComponent = class PropertiesComponent {
    constructor(appSettings, appService, mediaObserver) {
        ...
        this.viewCol = 33.3;
        this.count = 12;
        this.pagination = new _app_models__WEBPACK_IMPORTED_MODULE_7__["Pagination"](1, this.count, null, 2, 0, 0);
    ...
    resetPagination() {
        ...
        this.pagination = new _app_models__WEBPACK_IMPORTED_MODULE_7__["Pagination"](1, this.count, null, null, this.pagination.total, this.pagination.totalPages);
    }
    filterData(data) {
    ...
    searchChanged(event) {
        ...
        event.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["debounceTime"])(500), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["distinctUntilChanged"])()).subscribe(() => {
            if (!this.settings.searchOnBtnClick) {
                this.getProperties();
            }
        });
...
PropertiesComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-properties',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./properties.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/properties/properties.component.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./properties.component.scss */ "./src/app/pages/properties/properties.component.scss")).default]
    })
], PropertiesComponent);
...
/* harmony import */ var _properties_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./properties.component */ "./src/app/pages/properties/properties.component.ts");
/* harmony import */ var _property_property_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./property/property.component */ "./src/app/pages/properties/property/property.component.ts");
...
const routes = [
    { path: '', component: _properties_component__WEBPACK_IMPORTED_MODULE_7__["PropertiesComponent"], pathMatch: 'full' },
    { path: ':id', component: _property_property_component__WEBPACK_IMPORTED_MODULE_8__["PropertyComponent"] }
];
let PropertiesModule = class PropertiesModule {
};
PropertiesModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [
            _properties_component__WEBPACK_IMPORTED_MODULE_7__["PropertiesComponent"],
...
/* harmony import */ var src_app_shared_compare_overview_compare_overview_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! src/app/shared/compare-overview/compare-overview.component */ "./src/app/shared/compare-overview/compare-overview.component.ts");
...
let PropertyComponent = class PropertyComponent {
    ...
    ngOnInit() {
        ...
        this.mortgageForm = this.fb.group({
            principalAmount: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
            downPayment: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
        ...
        this.contactForm = this.fb.group({
            ...
            email: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required, src_app_theme_utils_app_validators__WEBPACK_IMPORTED_MODULE_9__["emailValidator"]])],
    ...
    addToCompare() {
        this.appService.addToCompare(this.property, src_app_shared_compare_overview_compare_overview_component__WEBPACK_IMPORTED_MODULE_7__["CompareOverviewComponent"], (this.settings.rtl) ? 'rtl' : 'ltr');
    }
    onCompare() {
...
PropertyComponent.propDecorators = {
    sidenav: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"], args: ['sidenav',] }],
    swipers: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChildren"], args: [ngx_swiper_wrapper__WEBPACK_IMPORTED_MODULE_5__["SwiperDirective"],] }],
    onWindowResize: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["HostListener"], args: ['window:resize',] }]
};
PropertyComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-property',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./property.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/properties/property/property.component.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./property.component.scss */ "./src/app/pages/properties/property/property.component.scss")).default]
    })
], PropertyComponent);
