...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-login-login-module"], {
  ...
  function srcAppPagesLoginLoginComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var LoginComponent = /*#__PURE__*/function () {
      function LoginComponent(fb, router, logger) {
      ...
      _createClass(LoginComponent, [{
        ...
        value: function onLoginFormSubmit(values) {
          this.logger.log(values.username);
          this.logger.log(values.password);
          this.logger.log(values.rememberMe);
  ...
  function srcAppServicesLogServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var LogService = /*#__PURE__*/function () {
      ...
      _createClass(LogService, [{
        ...
        value: function log(msg) {
          var now = moment__WEBPACK_IMPORTED_MODULE_2__().format('hh:mm:ss');
    ...
    LogService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    })], LogService);
    /***/
  }
