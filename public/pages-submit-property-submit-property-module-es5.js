...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-submit-property-submit-property-module"], {
  ...
  function srcAppPagesSubmitPropertySubmitPropertyComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      _createClass(SubmitPropertyComponent, [{
        ...
        value: function placesAutocomplete() {
          ...
          this.mapsAPILoader.load().then(function () {
            var autocomplete = new google.maps.places.Autocomplete(_this2.addressAutocomplete.nativeElement, {
              types: ["address"]
            });
        ...
        value: function getAddress() {
          ...
          this.appService.getAddress(this.lat, this.lng).subscribe(function (response) {
            ...
            if (response['results'].length) {
              ...
              _this3.submitForm.controls.address.get('location').setValue(address);

              _this3.setAddresses(response['results'][0]);
            }
          });
        }
      }, {
        ...
        value: function setAddresses(result) {
          ...
          result.address_components.forEach(function (item) {
            if (item.types.indexOf('locality') > -1) {
              if (_this4.cities.filter(function (city) {
                return city.name == item.long_name;
              })[0]) {
                newCity = _this4.cities.filter(function (city) {
                  return city.name == item.long_name;
                })[0];
              } else {
                newCity = {
                  id: _this4.cities.length + 1,
                  name: item.long_name
                };

                _this4.cities.push(newCity);
              }

              _this4.submitForm.controls.address.get('city').setValue(newCity);
            }

            if (item.types.indexOf('postal_code') > -1) {
              _this4.submitForm.controls.address.get('zipCode').setValue(item.long_name);
            }
          });
          ...
          if (newCity) {
            result.address_components.forEach(function (item) {
              if (item.types.indexOf('neighborhood') > -1) {
                var neighborhood = _this4.neighborhoods.filter(function (n) {
                ...
                if (neighborhood) {
                  ...
                  newNeighborhood = {
                    id: _this4.neighborhoods.length + 1,
                    name: item.long_name,
                    cityId: newCity.id
                  };

                  _this4.neighborhoods.push(newNeighborhood);
                }

                _this4.neighborhoods = _toConsumableArray(_this4.neighborhoods);

                _this4.submitForm.controls.address.get('neighborhood').setValue([newNeighborhood]);
              }
            });
          }
          ...
          if (newCity) {
            result.address_components.forEach(function (item) {
              if (item.types.indexOf('route') > -1) {
                if (_this4.streets.filter(function (street) {
                  return street.name == item.long_name && street.cityId == newCity.id;
                })[0]) {
                  newStreet = _this4.streets.filter(function (street) {
                    return street.name == item.long_name && street.cityId == newCity.id;
                  })[0];
                } else {
                  newStreet = {
                    id: _this4.streets.length + 1,
                    name: item.long_name,
                    cityId: newCity.id,
                    neighborhoodId: newNeighborhood ? newNeighborhood.id : null
                  };

                  _this4.streets.push(newStreet);
                }

                _this4.streets = _toConsumableArray(_this4.streets);

                _this4.submitForm.controls.address.get('street').setValue([newStreet]);
              }
            });
          }
        } // -------------------- Additional ---------------------------
    ...
    SubmitPropertyComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
  ...
  function srcAppPagesSubmitPropertySubmitPropertyModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ngx_input_file__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ngx-input-file */
    "./node_modules/ngx-input-file/__ivy_ngcc__/fesm2015/ngx-input-file.js");
    /* harmony import */


    var _submit_property_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./submit-property.component */
    "./src/app/pages/submit-property/submit-property.component.ts");

    var routes = [{
      path: '',
      component: _submit_property_component__WEBPACK_IMPORTED_MODULE_7__["SubmitPropertyComponent"],
      pathMatch: 'full'
    }];
    ...
    SubmitPropertyModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      declarations: [_submit_property_component__WEBPACK_IMPORTED_MODULE_7__["SubmitPropertyComponent"]],
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterModule"].forChild(routes), _shared_shared_module__WEBPACK_IMPORTED_MODULE_4__["SharedModule"], _agm_core__WEBPACK_IMPORTED_MODULE_5__["AgmCoreModule"], ngx_input_file__WEBPACK_IMPORTED_MODULE_6__["InputFileModule"]]
